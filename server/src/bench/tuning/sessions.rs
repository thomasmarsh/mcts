...
use mcts_bench::tuning_lifecycle::{OpponentSnapshot, StrategyMetrics, TrialReportReason};
...
pub(super) struct TuningSessionRow {
    session_id: String,
    status: String,
    target_trial_count: Option<i64>,
...
pub(super) fn load_trial_counts(
    db: &Connection,
    session_id: &str,
...
pub(super) struct PairRow {
    pub(super) pair_id: String,
    pub(super) pair_index: u32,
    pub(super) status: String,
    pub(super) seed: u64,
    pub(super) round: u32,
    pub(super) opponent: String,
    pub(super) pool_snapshot_fingerprint: String,
    pub(super) rating_before_mu: f64,
    pub(super) rating_before_sigma: f64,
    pub(super) rating_after_mu: Option<f64>,
    pub(super) rating_after_sigma: Option<f64>,
    pub(super) score: Option<f64>,
    pub(super) failure: Option<String>,
}

impl PairRow {
    pub(super) fn from_row(row: &duckdb::Row<'_>) -> Result<Self, duckdb::Error> {
        Ok(Self {
            pair_id: row.get(0)?,

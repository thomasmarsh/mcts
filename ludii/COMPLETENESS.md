...
dedicated Rust variants -- see `DESIGN.md`'s "Design principles" corollary and `README.md`'s
...
"doesn't read well" signal (already flagged twice in `README.md`'s own session notes, for `fixpoint`/

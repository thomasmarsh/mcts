...
const INITIAL_BLACK: u64 = (1 << 28) | (1 << 35); // e4, d5
const INITIAL_WHITE: u64 = (1 << 27) | (1 << 36); // d4, e5
...
const ZOBRIST_ENTRIES: usize = 130;
const ZOBRIST_TURN: usize = 128;
const ZOBRIST_LAST_PASS: usize = 129;

/// Random Zobrist table, lazily initialised.
static HASHES: LazyZobristTable<ZOBRIST_ENTRIES> =
...
#[inline]
fn xor_piece(hashes: &mut [u64; 8], pos: usize, player: Player) {
...
fn xor_piece_range(hashes: &mut [u64; 8], bits: u64, player: Player) {

...
export function mockTunerEnv(over: Partial<TunerEnv> = {}): TunerEnv {
  const base: TunerEnv = {
    ...
    getProjectionActiveEliminations: () => Effect.send([]),
  };
  return { ...base, ...over };
}

...
/// `BackpropPolicy::update_posterior` -- mirrors the root/edge split
/// `BackpropPolicy::update`'s score accumulation already has (`NodeStats`
...
/// unresolved slot or a `prior::PriorPolicy`-seeded-but-unvisited one

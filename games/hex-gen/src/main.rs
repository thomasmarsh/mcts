...
impl GameAdapter for HexGenAdapter {
    ...
    fn description(&self) -> &'static str {
        "Hex -- connect your two opposite edges. Generated by gdl's Core-IR-to-Rust codegen, \
         const-generic over board side so one generated crate serves 5x5, 7x7, and regulation \
         11x11 boards."
    }

...
type Board = bitboard::Board<u64, Const<3>, Const<3>>;
...
impl Position {
    ...
    pub fn winner(&self) -> Option<Player> {
        ...
        let won = {
            (Board::from_bits(0b111)).is_subset(board)
                || (Board::from_bits(0b111000)).is_subset(board)
                || (Board::from_bits(0b111000000)).is_subset(board)
                || (Board::from_bits(0b1001001)).is_subset(board)
                || (Board::from_bits(0b10010010)).is_subset(board)
                || (Board::from_bits(0b100100100)).is_subset(board)
                || (Board::from_bits(0b100010001)).is_subset(board)
                || (Board::from_bits(0b1010100)).is_subset(board)
        };
        if won {

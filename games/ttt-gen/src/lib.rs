// @generated by `cargo run -p ludii --bin codegen -- ludii/style-c/sexpr/tic-tac-toe.sc TicTacToe` --
// do not edit by hand. Regenerate instead of patching -- see ludii/src/codegen/rect.rs.
//
// Tic-Tac-Toe, lowered from ludii/style-c/sexpr/tic-tac-toe.sc via ludii::core::Program.

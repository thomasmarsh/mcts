...
impl Move {
    pub const SWAP: Move = Move(0xff, 0);
    pub const NO_MOVE: Move = Move(0xfe, 0);

    pub fn new(index: u8, capture_mask: u64) -> Self {
...
impl<const N: usize> State<N> {
    ...
    #[inline(always)]
    pub fn black(&self) -> BitBoard<N, N> {
        self.black
    }

    #[inline(always)]
    pub fn white(&self) -> BitBoard<N, N> {
        self.white
    }

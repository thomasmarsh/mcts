// @generated by `cargo run -p gdl --bin codegen -- gdl/style-c/sexpr/hex.gdls Hex3` --
...
const SEED: u64 = 0x34fdd0d860ef5d7b;
...
#[derive(Debug, Clone)]
pub struct Hex3<const N: usize, const WORDS: usize>;

impl<const N: usize, const WORDS: usize> Game for Hex3<N, WORDS> {
